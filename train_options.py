...
class TrainOptions(BaseOptions):
    ...
    def __init__(self): # pylint: disable=super-init-not-called
        ...
        self.parser.add_argument('--ensemble_dir', type=str, dest='ensemble_dir', default="ckpt/",
        ...
        self.parser.add_argument('--max_steps', type=int, dest='max_steps', default=500, choices=[200, 500,1000],
        ...
        self.parser.add_argument('--forward_step_size', dest='forward_step_size', type=float, default=0.15,
        ...
        self.parser.add_argument('--local_policy_model', type=str, dest='local_policy_model', default='4plus',
                                choices=['2plus', '4plus', 'retrain'])

        self.parser.add_argument('--scenes_list', nargs='+')
        self.parser.add_argument('--dataset_type', type=str, default="mp3d")
        ...
        self.parser.add_argument('--reach_horizon', dest='reach_horizon', type=int, default=20,
