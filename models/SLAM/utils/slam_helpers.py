...
def calc_loss(curr_data, 
             im, depth, mask, color_mask, use_l1, 
             use_sil_for_loss, ignore_outlier_depth_loss, tracking):
    losses = {}
...
def params2rendervar(params):
    log_scales = params['log_scales'] if params['log_scales'].shape[-1] == 3 else torch.tile(params['log_scales'], (1, 3))
    rendervar = {
...
def transformed_params2depthplussilhouette(params, w2c, transformed_pts):
    ...
    rendervar = {
        'means3D': transformed_pts,
        # This is to adjust for the view matrix in camera for gaussians
